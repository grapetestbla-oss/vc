...
export const COSMETICS = [
  ...
  // ──────────────────────── «Фаст фуд»: три дня ─────────────────────
  // Отсылки, а не бренды: узнаваемо, но ни одного чужого товарного знака.
  // Шляпы занимают слот шлема, поэтому среди материалов нет ни одной брони —
  // иначе косметика давала бы защиту, а этого в проекте не бывает.
  {
    key: "ff_hat_burger",
    name: "Царь-бургер",
    description: "Тот самый, с огня. Голову греет, есть нельзя.",
    kind: "HAT",
    rarity: "rare",
  ...
  },
  {
    key: "ff_hat_fries",
    name: "Картошка фри",
    description: "Вкусно и, кажется, всё.",
    kind: "HAT",
    rarity: "common",
  ...
  {
    key: "ff_hat_bucket",
    name: "Ведро от полковника",
    description: "Крылышки закончились ещё вчера, ведро осталось.",
    kind: "HAT",
    rarity: "rare",
  ...
  },
  {
    ...
    description: "Трубочка есть, аппарат опять сломан.",
    kind: "HAT",
    rarity: "common",
  ...
  },
  {
    key: "ff_hat_golden",
    name: "Золотой бургер",
    description: "Легенда фуд-корта. Тридцать штук на весь сервер и больше никогда.",
    kind: "HAT",
    rarity: "legendary",
  ...
  },
  {
    key: "ff_trail_grill",
    name: "Дым от гриля",
    description: "За вами тянется запах мангала. Жарено на огне, а не в масле.",
    kind: "TRAIL",
    rarity: "common",
  ...
  },
  {
    key: "ff_aura_soda",
    name: "Газировка",
    description: "Пузырьки кружат вокруг, будто вас только что открыли.",
    kind: "AURA",
    rarity: "rare",
  ...
  },
  {
    key: "ff_pet_courier",
    name: "Курьер",
    description: "Курица с термосумкой духа. Бежит следом и вечно опаздывает.",
    kind: "PET",
    rarity: "epic",
  ...
  {
    key: "ff_join_order",
    name: "Вход: заказ готов",
    description: "При входе звенит колокольчик выдачи. Номер вашего заказа — вы.",
    kind: "JOIN_EFFECT",
    rarity: "rare",
  ...
  },
  {
    key: "ff_name_ketchup",
    name: "Кетчупный ник",
    description: "Ярко-красный ник. Отстирывается плохо.",
    kind: "NAME_COLOR",
    rarity: "common",
  ...
  },
  {
    key: "ff_title_gurman",
    name: "Титул «Гурман»",
    description: "Для тех, кто разбирается в еде из бумажного пакета.",
    kind: "TITLE",
    rarity: "rare",
  ...
  },
  {
    key: "ff_title_combo",
    name: "Титул «Комбо»",
    description: "Больше, чем сумма частей. И дешевле, если брать вместе.",
    kind: "TITLE",
    rarity: "epic",
  ...
  },
  {
    key: "ff_pet_mascot",
    name: "Маскот",
    description: "Награда за полный «Комбо-обед». В кейсах не выпадает.",
    kind: "PET",
    rarity: "legendary",
    payload: { entity: "VILLAGER", name: "Маскот" },
    seasonKey: SEASON,
    obtainable: false,
  },
];

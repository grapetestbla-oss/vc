...
export const metadata = { title: "Пользовательское соглашение — VanillaCraft" };

const SECTIONS: Section[] = [
  {
    title: "1. Общие положения",
    blocks: [
      `1.1. Настоящее Пользовательское соглашение (далее — «Соглашение») регулирует порядок использования сервиса ${SERVICE_NAME} — сайта ${SERVICE_DOMAIN} и игрового сервера (далее — «Сервис»), предоставляемого Администрацией.`,
      "1.2. Используя Сервис, включая регистрацию аккаунта, вход на игровой сервер, оплату услуг или получение доступа к материалам, Пользователь подтверждает, что полностью ознакомился с условиями настоящего Соглашения и принимает их в полном объёме.",
  ...
  },
  {
    ...
    blocks: [
      "2.1. Сервис предоставляет цифровые товары и услуги нематериального характера, включая, но не ограничиваясь: доступ к игровому серверу, внутреннюю валюту VanillaCoins, предметы и возможности внутри игры, оформление аккаунта и сервисные услуги.",
      ...
      "2.3. Пользователь осознаёт и соглашается, что ценность цифровых товаров и услуг Сервиса заключается в систематизации, форме подачи, сопровождении, поддержке и обновлениях, а не в эксклюзивности отдельных фрагментов информации.",
      ...
      "2.5. Внутренняя валюта VanillaCoins не является денежным средством, электронными деньгами или ценной бумагой: она не выводится, не обменивается на деньги и не передаётся между аккаунтами.",
    ],
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        "временные технические сбои и ограничения доступа, включая плановые технические работы.",
      ],
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        "нарушения условий настоящего Соглашения или правил сервера;",
      ...
      "6.4. Порядок обжалования блокировки описан на странице «Разбан»: решение по заявлению принимает главная администрация.",
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      "8.3. Полный порядок обработки данных описан в Политике конфиденциальности.",
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      "10.1. По всем вопросам Пользователь может обратиться в службу поддержки через форму обращений на сайте, в разделе «Поддержка».",
    ],
  },
];
...
export default function TermsPage() {
  return (
    <LegalDocument
      ...
      summary="Соглашение регулирует порядок использования сайта и игрового сервера VanillaCraft: характер цифровых товаров, отказ от гарантий, правила доступа, интеллектуальную собственность, платежи и возвраты."
      sections={SECTIONS}
      footer="Используя Сервис — регистрируя аккаунт на сайте или заходя на игровой сервер — Пользователь подтверждает, что ознакомлен с настоящим Соглашением и принимает его условия в полном объёме."
    />
  );
}

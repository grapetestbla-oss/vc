...
const FEATURES = [
  {
    ...
    text: "За мелкое нарушение вы не теряете прогресс — отрабатываете срок в шахте. Просто ждать долго: минута срока стоит десяти реальных. Быстрее — брать наряды у прораба.",
    accent: "var(--gold)",
  },
  {
